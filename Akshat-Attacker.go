...
/*
 Akshat-Attacker DoS tool on <strike>steroids</strike> goroutines. Just ported from Python with some improvements.


 This go program licensed under GPLv3.
 Copyright Akshat-Attacker akshatjoshikps@gmail.com
*/
